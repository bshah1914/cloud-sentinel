...
export default function ScoreTimeline({ account, provider }) {
  ...
  if (!data.length) return <div className="flex items-center justify-center h-full text-text-muted text-xs">No timeline data</div>;
