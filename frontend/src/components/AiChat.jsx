...
export default function AiChat() {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: "Welcome to CloudSentrix AI! I analyze your cloud infrastructure against the **AWS Well-Architected Framework** and security best practices.\n\nI can help with:\n- **Well-Architected analysis** across 6 pillars\n- **Security risk assessment** and findings\n- **Compliance recommendations** (CIS, SOC2, GDPR)\n- **Actionable remediation** steps\n\nWhat would you like to know?" }
  ]);
            ...
            {!minimized && (
              <>
                ...
                <div className="p-3 border-t border-border/20">
                  ...
                  <p className="text-[8px] text-text-muted/40 text-center mt-1.5">Powered by CloudSentrix Security Intelligence Engine</p>
                </div>
              </>
            )}
          </motion.div>
