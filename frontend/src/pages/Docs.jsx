    ...
    sections: [
      {
        ...
        content: `CloudSentrix is an enterprise multi-cloud security platform that helps you monitor, audit, and secure your AWS, Azure, and GCP infrastructure.
...
• Local ports 3000 (frontend) and 5000 (backend)`
      },
      {
        ...
        content: `CloudSentrix uses a modular plugin-based architecture:
    ...
    sections: [
      {
        ...
        content: `CloudSentrix includes an AI-powered security assistant that analyzes your actual cloud data.
          ...
          <motion.div key={currentDoc.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            ...
            <div className="report-header flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-text-muted">{currentDoc.sections.length} section(s) &bull; CloudSentrix v3.0</p>
              </div>
            </div>
